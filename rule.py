...
class Rule(object):
    ...
    def is_invalid(self, x, y): # out of range
        return (x < 0 or x >= board_size or y < 0 or y >= board_size)

    def set_stone(self, x, y, stone): # set stone
    ...
    def get_possible_points(self, stone):
        board = [[True for i in range(board_size)] for j in range(board_size)]
